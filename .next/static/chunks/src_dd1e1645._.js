...
"[project]/src/lib/generation-storage.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function LoadingStateContainer(param) {
    let { currentStatus, thinking, messageId, skeletonShrinking, isReconnecting } = param;
    _s();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-[#1a1a1a] border border-red-500/50 rounded-xl px-4 py-3 shadow-lg space-y-2 animate-pulse overflow-hidden origin-left ".concat(skeletonShrinking ? 'transition-all duration-[800ms] ease-out opacity-0 scale-x-0 -translate-x-4' : 'transition-all duration-[800ms] ease-out opacity-100 scale-x-100 translate-x-0'),
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        hasThinking && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(LoadingStateContainer, "wc5OGq6H3Bcs3gJhvOWgZbMuAPM=");
_c = LoadingStateContainer;
var _c;
__turbopack_context__.k.register(_c, "LoadingStateContainer");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function Messages(param) {
    let { messages, thinking, currentStatus, isLoading, isStreaming, streamingMessageId, skeletonShrinking, isReconnecting, messagesEndRef, conversationId } = param;
    _s();
...
_s(Messages, "xvE2tMf9RZa9Xc1TGOCYoL1UFKk=");
_c = Messages;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$generation$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/generation-storage.ts [app-client] (ecmascript)");
...
function ChatPage() {
    ...
    const [reconnectAttempted, setReconnectAttempted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const activeStreamRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null); // Track active stream by messageId
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatPage.useEffect": ()=>{
            ...
            const activeGeneration = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$generation$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generationStorage"].get();
            if (activeGeneration && !reconnectAttempted) {
                ...
                if (activeGeneration.conversationId !== activeId) {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$conversation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["conversationStorage"].setActiveId(activeGeneration.conversationId);
                }
                // Set loading state
                setIsLoading(true);
                setStreamingMessageId(activeGeneration.messageId);
                // Reconnect to dedicated reconnect endpoint (doesn't need full URL anymore)
                const reconnectUrl = "/api/v1/messages/".concat(activeGeneration.messageId, "/reconnect");
                streamMessage(activeGeneration.conversationId, activeGeneration.messageId, reconnectUrl).catch({
                    "ChatPage.useEffect": (error)=>{
                        console.error('[Reconnect] Failed to reconnect:', error);
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$generation$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generationStorage"].clear();
                        setIsLoading(false);
    ...
    const streamMessage = async (convId, messageId, responseOrUrl)=>{
        ...
        try {
            ...
            if (typeof responseOrUrl === 'string') {
                ...
                console.log("[Stream] Reconnecting to ".concat(responseOrUrl));
                ...
                try {
                    ...
                    if (!eventSource.ok) {
                        ...
                        if (eventSource.status === 404 && retryCount < maxRetries) {
                            ...
                            console.log("[Stream] Stream not ready (404), retrying in ".concat(delay, "ms... (attempt ").concat(retryCount + 1, "/").concat(maxRetries, ")"));
                    ...
                    if (reader) {
                        ...
                        while(true){
                            ...
                            console.log('[Stream] Read chunk - done:', done, 'value length:', value === null || value === void 0 ? void 0 : value.length);
                            if (done) break;
                    ...
                    console.log("[Stream] Connection failed, retrying in ".concat(delay, "ms... (attempt ").concat(retryCount + 1, "/").concat(maxRetries, ")"));
                    await new Promise((resolve)=>setTimeout(resolve, delay));
                    retryCount++;
                }
    ...
    const sendMessage = async ()=>{
        ...
        const messageId = "msg_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9));
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error("Failed to start generation: ".concat(response.status));
            }
            // Store generation info for reconnection
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$generation$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generationStorage"].set({
                messageId,
                conversationId: convId,
...
_s(ChatPage, "AObJAXD7/88fu2VC14gc6n+9tfI=");
_c = ChatPage;
var _c;
...
//# sourceMappingURL=src_dd1e1645._.js.map
module.exports = [
"[project]/node_modules/@langchain/openai/dist/utils/azure.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@langchain/openai/dist/utils/errors.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@langchain/openai/dist/utils/openai.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const openai_1 = __turbopack_context__.r("[project]/node_modules/openai/index.js [app-route] (ecmascript)");
...
Object.defineProperty(exports, "formatToOpenAIFunction", {
    enumerable: true,
    get: function() {
        return function_calling_1.convertToOpenAIFunction;
    }
});
Object.defineProperty(exports, "formatToOpenAITool", {
    enumerable: true,
    get: function() {
        return function_calling_1.convertToOpenAITool;
    }
});
...
const core_1 = __turbopack_context__.r("[project]/node_modules/zod/v4/core/index.cjs [app-route] (ecmascript)");
const zod_1 = __turbopack_context__.r("[project]/node_modules/openai/helpers/zod.js [app-route] (ecmascript)");
const errors_js_1 = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/utils/errors.cjs [app-route] (ecmascript)");
...
function formatToOpenAIAssistantTool(tool) {
    return {
        ...
        function: {
            ...
            parameters: (0, types_1.isInteropZodSchema)(tool.schema) ? (0, json_schema_1.toJsonSchema)(tool.schema) : tool.schema
        }
    };
}
...
"[project]/node_modules/@langchain/openai/dist/utils/openai-format-fndef.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@langchain/openai/dist/utils/tools.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const function_calling_1 = __turbopack_context__.r("[project]/node_modules/@langchain/core/utils/function_calling.cjs [app-route] (ecmascript)");
const openai_js_1 = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/utils/openai.cjs [app-route] (ecmascript)");
/**
...
"[project]/node_modules/@langchain/openai/dist/utils/output.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@langchain/openai/dist/chat_models.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const openai_tools_1 = __turbopack_context__.r("[project]/node_modules/@langchain/core/output_parsers/openai_tools.cjs [app-route] (ecmascript)");
const types_1 = __turbopack_context__.r("[project]/node_modules/@langchain/core/utils/types.cjs [app-route] (ecmascript)");
const json_schema_1 = __turbopack_context__.r("[project]/node_modules/@langchain/core/utils/json_schema.cjs [app-route] (ecmascript)");
const azure_js_1 = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/utils/azure.cjs [app-route] (ecmascript)");
const openai_js_1 = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/utils/openai.cjs [app-route] (ecmascript)");
const openai_format_fndef_js_1 = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/utils/openai-format-fndef.cjs [app-route] (ecmascript)");
const tools_js_1 = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/utils/tools.cjs [app-route] (ecmascript)");
const output_js_1 = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/utils/output.cjs [app-route] (ecmascript)");
...
function messageToOpenAIRole(message) {
    ...
    switch(type){
        ...
        case "generic":
            {
                if (!messages_1.ChatMessage.isInstance(message)) throw new Error("Invalid generic chat message");
...
/** @internal */ class BaseChatOpenAI extends chat_models_1.BaseChatModel {
    _llmType() {
        return "openai";
    }
    static lc_name() {
    ...
    constructor(fields){
        ...
        this.apiKey = fields?.apiKey ?? fields?.configuration?.apiKey ?? (0, env_1.getEnvironmentVariable)("OPENAI_API_KEY");
        this.organization = fields?.configuration?.organization ?? (0, env_1.getEnvironmentVariable)("OPENAI_ORGANIZATION");
     ...
     */ _getResponseFormat(resFormat) {
        if (resFormat && resFormat.type === "json_schema" && resFormat.json_schema.schema && (0, types_1.isInteropZodSchema)(resFormat.json_schema.schema)) {
    ...
    bindTools(tools, kwargs) {
        ...
        return this.withConfig({
            tools: tools.map((tool)=>(0, tools_js_1.isBuiltInTool)(tool) ? tool : this._convertChatOpenAIToolToCompletionsTool(tool, {
                    strict
                })),
            ...kwargs
        });
 ...
 */ class ChatOpenAIResponses extends BaseChatOpenAI {
    invocationParams(options) {
        ...
        const params = {
            ...
            tool_choice: (0, tools_js_1.isBuiltInToolChoice)(options?.tool_choice) ? options?.tool_choice : (()=>{
    ...
    /** @internal */ _convertResponsesMessageToBaseMessage(response) {
        ...
        for (const item of response.output){
            if (item.type === "message") {
                ...
                try {
                    tool_calls.push((0, openai_tools_1.parseToolCall)(fnAdapter, {
                        returnId: true
                    }));
                } catch (e) {
                    let errMessage;
            ...
            case "assistant":
                {
                    ...
                    for (const rawToolCall of rawToolCalls ?? []){
                        try {
                            toolCalls.push((0, openai_tools_1.parseToolCall)(rawToolCall, {
                                returnId: true
                            }));
                        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                        } catch (e) {
...
"[project]/node_modules/@langchain/openai/dist/utils/headers.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@langchain/openai/dist/azure/chat_models.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const openai_1 = __turbopack_context__.r("[project]/node_modules/openai/index.js [app-route] (ecmascript)");
const env_1 = __turbopack_context__.r("[project]/node_modules/@langchain/core/utils/env.cjs [app-route] (ecmascript)");
const chat_models_js_1 = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/chat_models.cjs [app-route] (ecmascript)");
const azure_js_1 = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/utils/azure.cjs [app-route] (ecmascript)");
const headers_js_1 = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/utils/headers.cjs [app-route] (ecmascript)");
const AZURE_ALIASES = {
...
function _constructAzureFields(fields) {
    this.azureOpenAIApiKey = fields?.azureOpenAIApiKey ?? fields?.openAIApiKey ?? fields?.apiKey ?? (0, env_1.getEnvironmentVariable)("AZURE_OPENAI_API_KEY");
    this.azureOpenAIApiInstanceName = fields?.azureOpenAIApiInstanceName ?? (0, env_1.getEnvironmentVariable)("AZURE_OPENAI_API_INSTANCE_NAME");
    this.azureOpenAIApiDeploymentName = fields?.azureOpenAIApiDeploymentName ?? fields?.deploymentName ?? (0, env_1.getEnvironmentVariable)("AZURE_OPENAI_API_DEPLOYMENT_NAME");
    this.azureOpenAIApiVersion = fields?.azureOpenAIApiVersion ?? fields?.openAIApiVersion ?? (0, env_1.getEnvironmentVariable)("AZURE_OPENAI_API_VERSION");
    this.azureOpenAIBasePath = fields?.azureOpenAIBasePath ?? (0, env_1.getEnvironmentVariable)("AZURE_OPENAI_BASE_PATH");
    this.azureOpenAIEndpoint = fields?.azureOpenAIEndpoint ?? (0, env_1.getEnvironmentVariable)("AZURE_OPENAI_ENDPOINT");
...
"[project]/node_modules/@langchain/openai/dist/llms.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ class OpenAI extends llms_1.BaseLLM {
    ...
    constructor(fields){
        ...
        this.openAIApiKey = fields?.apiKey ?? fields?.openAIApiKey ?? (0, env_1.getEnvironmentVariable)("OPENAI_API_KEY");
...
"[project]/node_modules/@langchain/openai/dist/azure/llms.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const openai_1 = __turbopack_context__.r("[project]/node_modules/openai/index.js [app-route] (ecmascript)");
const env_1 = __turbopack_context__.r("[project]/node_modules/@langchain/core/utils/env.cjs [app-route] (ecmascript)");
const llms_js_1 = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/llms.cjs [app-route] (ecmascript)");
const azure_js_1 = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/utils/azure.cjs [app-route] (ecmascript)");
const headers_js_1 = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/utils/headers.cjs [app-route] (ecmascript)");
class AzureOpenAI extends llms_js_1.OpenAI {
    ...
    constructor(fields){
        ...
        this.azureOpenAIApiDeploymentName = (fields?.azureOpenAIApiCompletionsDeploymentName || fields?.azureOpenAIApiDeploymentName) ?? ((0, env_1.getEnvironmentVariable)("AZURE_OPENAI_API_COMPLETIONS_DEPLOYMENT_NAME") || (0, env_1.getEnvironmentVariable)("AZURE_OPENAI_API_DEPLOYMENT_NAME"));
        this.azureOpenAIApiKey = fields?.azureOpenAIApiKey ?? fields?.openAIApiKey ?? fields?.apiKey ?? (0, env_1.getEnvironmentVariable)("AZURE_OPENAI_API_KEY");
        this.azureOpenAIApiInstanceName = fields?.azureOpenAIApiInstanceName ?? (0, env_1.getEnvironmentVariable)("AZURE_OPENAI_API_INSTANCE_NAME");
        this.azureOpenAIApiVersion = fields?.azureOpenAIApiVersion ?? fields?.openAIApiVersion ?? (0, env_1.getEnvironmentVariable)("AZURE_OPENAI_API_VERSION");
        this.azureOpenAIBasePath = fields?.azureOpenAIBasePath ?? (0, env_1.getEnvironmentVariable)("AZURE_OPENAI_BASE_PATH");
...
"[project]/node_modules/@langchain/openai/dist/embeddings.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ class OpenAIEmbeddings extends embeddings_1.Embeddings {
    constructor(fields){
        ...
        const apiKey = fieldsWithDefaults?.apiKey ?? fieldsWithDefaults?.openAIApiKey ?? (0, env_1.getEnvironmentVariable)("OPENAI_API_KEY");
        this.organization = fieldsWithDefaults?.configuration?.organization ?? (0, env_1.getEnvironmentVariable)("OPENAI_ORGANIZATION");
...
"[project]/node_modules/@langchain/openai/dist/azure/embeddings.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const openai_1 = __turbopack_context__.r("[project]/node_modules/openai/index.js [app-route] (ecmascript)");
const env_1 = __turbopack_context__.r("[project]/node_modules/@langchain/core/utils/env.cjs [app-route] (ecmascript)");
const embeddings_js_1 = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/embeddings.cjs [app-route] (ecmascript)");
const azure_js_1 = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/utils/azure.cjs [app-route] (ecmascript)");
const openai_js_1 = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/utils/openai.cjs [app-route] (ecmascript)");
const headers_js_1 = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/utils/headers.cjs [app-route] (ecmascript)");
class AzureOpenAIEmbeddings extends embeddings_js_1.OpenAIEmbeddings {
    constructor(fields){
        ...
        this.azureOpenAIApiKey = fields?.azureOpenAIApiKey ?? fields?.apiKey ?? (0, env_1.getEnvironmentVariable)("AZURE_OPENAI_API_KEY");
        this.azureOpenAIApiVersion = fields?.azureOpenAIApiVersion ?? fields?.openAIApiVersion ?? (0, env_1.getEnvironmentVariable)("AZURE_OPENAI_API_VERSION");
        this.azureOpenAIBasePath = fields?.azureOpenAIBasePath ?? (0, env_1.getEnvironmentVariable)("AZURE_OPENAI_BASE_PATH");
        this.azureOpenAIApiInstanceName = fields?.azureOpenAIApiInstanceName ?? (0, env_1.getEnvironmentVariable)("AZURE_OPENAI_API_INSTANCE_NAME");
        this.azureOpenAIApiDeploymentName = (fields?.azureOpenAIApiEmbeddingsDeploymentName || fields?.azureOpenAIApiDeploymentName) ?? ((0, env_1.getEnvironmentVariable)("AZURE_OPENAI_API_EMBEDDINGS_DEPLOYMENT_NAME") || (0, env_1.getEnvironmentVariable)("AZURE_OPENAI_API_DEPLOYMENT_NAME"));
        this.azureADTokenProvider = fields?.azureADTokenProvider;
    }
    async embeddingWithRetry(request) {
        if (!this.client) {
...
"[project]/node_modules/@langchain/openai/dist/types.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@langchain/openai/dist/tools/dalle.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
/* eslint-disable no-param-reassign */ const env_1 = __turbopack_context__.r("[project]/node_modules/@langchain/core/utils/env.cjs [app-route] (ecmascript)");
const openai_1 = __turbopack_context__.r("[project]/node_modules/openai/index.js [app-route] (ecmascript)");
 ...
 */ class DallEAPIWrapper extends tools_1.Tool {
    ...
    constructor(fields){
        ...
        const openAIApiKey = fields?.apiKey ?? fields?.openAIApiKey ?? (0, env_1.getEnvironmentVariable)("OPENAI_API_KEY");
...
"[project]/node_modules/@langchain/openai/dist/tools/index.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
__exportStar(__turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/tools/dalle.cjs [app-route] (ecmascript)"), exports);
}),
"[project]/node_modules/@langchain/openai/dist/utils/prompts.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@langchain/openai/dist/tools/custom.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@langchain/openai/dist/index.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var openai_1 = __turbopack_context__.r("[project]/node_modules/openai/index.js [app-route] (ecmascript)");
Object.defineProperty(exports, "OpenAIClient", {
    enumerable: true,
    get: function() {
        return openai_1.OpenAI;
    }
});
Object.defineProperty(exports, "toFile", {
    enumerable: true,
    get: function() {
        return openai_1.toFile;
    }
});
__exportStar(__turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/chat_models.cjs [app-route] (ecmascript)"), exports);
__exportStar(__turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/azure/chat_models.cjs [app-route] (ecmascript)"), exports);
__exportStar(__turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/llms.cjs [app-route] (ecmascript)"), exports);
__exportStar(__turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/azure/llms.cjs [app-route] (ecmascript)"), exports);
__exportStar(__turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/azure/embeddings.cjs [app-route] (ecmascript)"), exports);
__exportStar(__turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/embeddings.cjs [app-route] (ecmascript)"), exports);
__exportStar(__turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/types.cjs [app-route] (ecmascript)"), exports);
__exportStar(__turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/utils/openai.cjs [app-route] (ecmascript)"), exports);
__exportStar(__turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/utils/azure.cjs [app-route] (ecmascript)"), exports);
__exportStar(__turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/tools/index.cjs [app-route] (ecmascript)"), exports);
var prompts_js_1 = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/utils/prompts.cjs [app-route] (ecmascript)");
Object.defineProperty(exports, "convertPromptToOpenAI", {
    enumerable: true,
    get: function() {
        return prompts_js_1.convertPromptToOpenAI;
    }
});
var custom_js_1 = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/tools/custom.cjs [app-route] (ecmascript)");
Object.defineProperty(exports, "customTool", {
    enumerable: true,
    get: function() {
        return custom_js_1.customTool;
    }
});
}),
"[project]/node_modules/@langchain/openai/index.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

module.exports = __turbopack_context__.r("[project]/node_modules/@langchain/openai/dist/index.cjs [app-route] (ecmascript)");
}),
];

//# sourceMappingURL=node_modules_%40langchain_openai_2a754df1._.js.map
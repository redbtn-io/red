...
class MessageQueue {
     ...
     */ publishToolStatus(messageId, toolInfo) {
        return __awaiter(this, void 0, void 0, function*() {
            ...
            if (stateJson) {
                const state = JSON.parse(stateJson);
                console.log(`[MessageQueue] Current state before update:`, {
     ...
     */ subscribeToMessage(messageId) {
        return __asyncGenerator(this, arguments, function* subscribeToMessage_1() {
            ...
            if (state.currentStatus) {
                ...
                yield yield __await({
                    type: state.currentStatus.action.includes('search') || state.currentStatus.action.includes('scrape') || state.currentStatus.action.includes('command') ? 'tool_status' : 'status',
 ...
 */ const routerNode = (state)=>__awaiter(void 0, void 0, void 0, function*() {
        ...
        const messageId = (_e = state.options) === null || _e === void 0 ? void 0 : _e.messageId;
        ...
        try {
            ...
            try {
                for(var _k = true, stream_1 = __asyncValues(stream), stream_1_1; stream_1_1 = yield __await(stream_1.next()), _a = stream_1_1.done, !_a; _k = true){
                    ...
                    if (event.event === "on_llm_stream" && ((_f = (_e = event.data) === null || _e === void 0 ? void 0 : _e.chunk) === null || _f === void 0 ? void 0 : _f.content) && !isRouterOrToolPicker) {
                        ...
                        for(let i = 0; i < content.length; i++){
                            ...
                            if (!inThinkingTag && content.slice(i, i + 7) === '<think>') {
                                ...
                                if (messageId) {
                                    yield __await(red.messageQueue.publishStatus(messageId, {
                                        action: 'thinking',
...
//# sourceMappingURL=node_modules_%40redbtn_ai_dist_ebfab013._.js.map
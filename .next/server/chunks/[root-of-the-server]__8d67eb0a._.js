module.exports = [
"[project]/.next-internal/server/app/api/v1/conversations/[id]/generation-state/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/v1/conversations/[id]/generation-state/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const state = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$red$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["red"].logger.getConversationGenerationState(conversationId);
        if (!state) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                conversationId,
                isGenerating: false,
        ...
        if (state.currentGenerationId) {
            const generation = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$red$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["red"].logger.getGeneration(state.currentGenerationId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8d67eb0a._.js.map
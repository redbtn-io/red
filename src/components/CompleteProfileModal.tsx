...
export function CompleteProfileModal({ isOpen, onClose, onSuccess, canDismiss = false }: CompleteProfileModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-[#1a1a1a] border border-red-500/30 rounded-2xl shadow-2xl max-w-md w-full p-8">
        {/* Logo/Title */}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-black/30 border border-gray-700 rounded-lg px-10 py-3 text-white placeholder-gray-500 focus:border-red-500 focus:outline-none transition-colors [color-scheme:dark]"
                required
                disabled={loading}
              />
            </div>
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              <div className="relative flex items-center justify-center mt-0.5">
                ...
                <div className="w-5 h-5 border-2 border-gray-700 rounded bg-black/30 peer-checked:bg-red-500 peer-checked:border-red-500 transition-colors flex items-center justify-center">
                  {agreedToTerms && <CheckSquare size={16} className="text-white" />}
                </div>
              </div>
